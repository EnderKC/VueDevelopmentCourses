...
public class MySQLCodeGeneratop {
    public static void main(String[] args) {
        FastAutoGenerator.create("jdbc:mysql://localhost:3306/bighomework?characterEncoding=UTF-8&useUnicode=true&serverTimezone=GMT&connectTimeout=15000", "root", "20021001")
