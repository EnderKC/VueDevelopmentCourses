<template>
  <div class="bodyStyle">
    ...
    <a-form
      ...
      <a-row :gutter="24">
        <a-col :span="8">
          <a-form-item :name="`stuname`" :label="`姓名`">
            <a-input v-model:value="searchFormState[`stuname`]" placeholder="请输入角色"></a-input>
          </a-form-item>
        </a-col>
        <a-col :span="8">
      ...
      <a-form
        ...
        <a-form-item
          ...
          :rules="[
            ...
            { min: 2, max: 10, message: '长度在 2 to 10', trigger: 'blur' }
          ]"
          class="error-align">
          <a-input v-model:value="dialogFormState.stuname"></a-input>
        </a-form-item>
        <a-form-item
          ref="gender"
          label="性别"
          name="gender"
          class="error-align">
          <a-radio-group v-model:value="dialogFormState.gender">
        ...
        <a-form-item
          ...
          name="birthday"
          class="error-align">
          <a-date-picker v-model:value="dialogFormState.birthday"/>
        </a-form-item>
        <a-form-item
          has-feedback
          label="班级"
          ...
          class="error-align">
          <a-input v-model:value="dialogFormState.classname"></a-input>
        </a-form-item>
        <a-form-item has-feedback ref="address" label="籍贯" name="address" class="error-align">
          <a-input v-model:value="dialogFormState.address" />
        </a-form-item>
      </a-form>
    </a-modal>
    <!-------新增/更新对话框结束--------->
...
import StudentInfoApi from '@/api/studentInfo'
...
const studentInfoApi = new StudentInfoApi()
...
// 对话框标题
const dialogTitle = ref<string>('新增选课')
...
const columns: TableColumnsType = [
  ...
  { title: '姓名', dataIndex: 'stuname', key: 'stuname', width: 150 },
  { title: '班级', dataIndex: 'classname', key: 'classname', width: 100 },
  { title: '籍贯', dataIndex: 'address', key: 'address', width: 100 },
  {
    title: '操作',
    key: 'operation',
    fixed: 'right',
...
// 清空表单
const resetForm = () => {
  searchFormState.classname = ''
  searchFormState.stuname = ''
}
