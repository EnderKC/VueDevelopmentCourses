...
public class CourseServiceImpl extends ServiceImpl<CourseMapper, Course>implements CourseService {
     ...
     */
    @Override
    public List<Course> listByCriteria(Course criteria){
    ...
    public boolean saveEntity(Course entity){
    ...
    */
    @Override
    @Transactional(readOnly=false,rollbackFor=Exception.class)
    public boolean batchSaveEntity(List<Course> list) {
    ...
    @Override
    @Transactional(readOnly=false,rollbackFor=Exception.class)
    public boolean updateEntity(Course entity){
        //entity中的主键是否为空，为空返false
        if(entity.getCid()==null){
            return false;
        }
        //判断要更新对象在数据库是否存在，不存在返回false
        if(this.getEntityById(entity.getCid())==null){
            return false;
        }
    ...
    @Override
    @Transactional(readOnly=false,rollbackFor=Exception.class)
    public int deleteByCriteria(Course criteria){
